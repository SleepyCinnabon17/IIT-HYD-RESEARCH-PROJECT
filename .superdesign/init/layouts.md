# Layout
Single Gradio Blocks page; upload and annotation in two columns, followed by run action, risk, explanation and metrics. No shared custom navigation or separate layouts.
```python
